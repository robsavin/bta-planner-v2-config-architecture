    ...
    <DialogPortal container={portalContainer}>
      ...
      >
        <DialogPrimitive.Content
          ...
          className={cn(
            "relative z-[9999] flex min-h-0 flex-col w-[calc(100%-2rem)] max-w-[560px] max-h-[calc(100dvh-2rem)] sm:max-h-[90vh] gap-4 border bg-background p-6 shadow-lg duration-200 overflow-hidden box-border rounded-lg data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95",
            className,
          )}
          style={{
            zIndex: 9999,
          ...
          {...props}
        >
          <div className="min-h-0 flex-1 overflow-x-hidden overflow-y-auto [-webkit-overflow-scrolling:touch] overscroll-y-contain pr-8">
            {children}
          </div>
